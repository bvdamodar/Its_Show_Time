...
public class Location_Activity extends AppCompatActivity {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Location_Activity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Location_Activity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
    ...
    public void getAddress(double lat, double lng) {
        ...
        try {
            ...
            t1.setText(obj.getCountryName());
            t3.setText(obj.getAdminArea());
            t4.setText(obj.getPostalCode());
            t5.setText(obj.getSubAdminArea());
            t6.setText(obj.getLocality());
            t7.setText(obj.getSubThoroughfare());
