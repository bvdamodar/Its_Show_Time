        ...
        navigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.navigation_home) {
                    ...
                    Intent a = new Intent(ConfirmationActivity.this,Profile_Activity.class);
                    startActivity(a);
                    return true;}
                    ...
                    Intent a = new Intent(ConfirmationActivity.this,Cust_Sign_In.class);
                    startActivity(a);
...
//                    seatIds.add(seats.get(i).getSeatID());
                    ...
                    itemDetailIntent.putExtra("TotalPrice",price );
